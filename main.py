...
def question():
  ...
  if password1 < 27:
    print("BEBAAWWBEREBAWW THE POpcorn is eat we used Just Eat you should use Just Eat tooopooooo ARE HERE")
  elif password1 < 29:
    clear()
    print("Congrats police are coming to buckingham palace!\n")

    password2 = int(
        input("Enter your password (hint it is one " + red + "number" + white +
              " long and is a multiple \nof 6): "))
    if password2 < 5:
