...
password1 = int(input(white+"Enter your password (hint, it begins with 2 and ends in 8): "))
if password1 < 27:
  ...
  password2 = int(input("Enter your password (hint it is one "+red+"number"+white+" long and is a multiple \nof 6): "))
  if password2 < 5:
    ...
    botdetector2000 = str(input("If you are a computer then please type yes if not then type no: "))
